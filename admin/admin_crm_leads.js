window.initializePage = function() {
    ...
    window.copysOutbound = {
        intro: `Olá, [PRIMEIRO NOME]! Tudo bem?\n\nSou Anderson Costa, psicólogo clínico e fundador da Yelo.\n\nEstamos construindo uma comunidade de psicólogos que conecta profissionais a novos pacientes e também promove troca de experiências entre colegas.\n\nAchei que a proposta poderia fazer sentido para você.\n\nPosso te explicar rapidamente como funciona? Prometo que são apenas duas mensagens. 😊`,
        
        pitch: `Maravilha, [PRIMEIRO NOME]! Serei bem direto, porque sei que a vida é corrida.\n\nA Yelo não é uma daquelas listas genéricas de profissionais. Nós construímos um Hub completo: o paciente responde a um questionário e nosso algoritmo faz o Match Inteligente, direcionando-o para a sua especialidade.\n\nAlém disso, a plataforma oferece ferramentas de gestão e troca de saberes 🤝:\n🧠 Fórum privado para discussões\n✍️ Blog para escrever aos usuários\n📊 Gestão financeira\n🌐 Página pública com endereço personalizado\n\nNa Yelo você tem total autonomia: define seus horários, valores, edita seu perfil, etc.\n\nComo estamos selecionando profissionais referência para esta fase, liberei **7 dias de acesso Premium gratuito para você testar na prática, sem precisar cadastrar nenhum cartão**. O que acha?\n\nwww.yelopsi.com.br/profissionais`,
        
        followup1: `Oi, [PRIMEIRO NOME], tudo bem?\n\nConseguiu dar uma olhada no link da Yelo que te enviei?\n\nGostaria muito de ter um colega com a sua visão na nossa rede. Nossos primeiros 7 dias Premium são totalmente sem custo **(e sem pedir cartão)** para você sentir como nossa gestão e nosso algoritmo podem te ajudar na captação de pacientes de forma ética.\n\nQualquer dúvida, estou à disposição!`,
