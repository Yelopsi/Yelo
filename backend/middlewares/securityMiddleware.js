...
const cspMiddleware = (req, res, next) => {
    const csp = [
        ...
        "connect-src 'self' ws: wss: https://*.google-analytics.com https://www.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://www.googletagmanager.com https://googleads.g.doubleclick.net https://*.g.doubleclick.net https://www.googleadservices.com https://*.google.com https://*.google.com.br https://*.facebook.com https://cdn.jsdelivr.net https://unpkg.com https://cdn.quilljs.com https://*.clarity.ms https://clarity.ms https://viacep.com.br " + (process.env.FRONTEND_URL || 'http://localhost:3001'),
