...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const questions = [
        ...
        { id: 'praticas_afirmativas', question: "Sua prática é afirmativa para quais comunidades ou perspectivas?", type: 'multiple-choice', scrollable: true, choices: ["Faz parte da comunidade LGBTQIAPN+ / Afirmativa", "Pessoa não-branca / Prática Antirracista", "Perspectiva Feminista", "Neurodiversidade (TDAH, Autismo)", "Nenhuma específica"], required: true, buttonText: "Verificar Demanda" },
